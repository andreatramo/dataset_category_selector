...
def main():
    ...
    if database_type == "openimage":
        ...
        print("START: New sub-selection: ")

        label_map = "/home/andreatramo/datasets/openimage/my_oid_label_map.pbtxt"
        train_box = "/home/andreatramo/datasets/openimage/my_openimage/annotations/new_train-annotations-bbox.csv"
        val_box = "/home/andreatramo/datasets/openimage/my_openimage/annotations/new_validation-annotations-bbox.csv"
        test_box = "/home/andreatramo/datasets/openimage/my_openimage/annotations/new_test-annotations-bbox.csv"
        train_verification = "/home/andreatramo/datasets/openimage/my_openimage/annotations/new_train-annotations-human-imagelabels-boxable.csv"
        val_verification = "/home/andreatramo/datasets/openimage/my_openimage/annotations/new_validation-annotations-human-imagelabels-boxable.csv"
        test_verification = "/home/andreatramo/datasets/openimage/my_openimage/annotations/new_test-annotations-human-imagelabels-boxable.csv"
        train_image_dir = "/home/andreatramo/datasets/openimage/my_openimage/images/train"
        val_image_dir = "/home/andreatramo/datasets/openimage/my_openimage/images/val"
        test_image_dir = "/home/andreatramo/datasets/openimage/my_openimage/images/test"
        output_dir = "/home/andreatramo/datasets/openimage/my_openimage_sub"
        ...
        sub_database = OpenimageDB(input_file, output_dir)
        sub_database.img_selector()

        print("Number of object found: " + str(sub_database.get_num_object_found()))
        print("Number of images not found: " + str(sub_database.get_img_not_found()))
